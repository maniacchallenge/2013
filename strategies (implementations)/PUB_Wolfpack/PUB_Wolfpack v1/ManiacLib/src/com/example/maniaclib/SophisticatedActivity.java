...
import de.fu_berlin.maniac.strategies.MyStrategy;
...
public class SophisticatedActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (maniac != null) {
			maniac.setStrategy(new MyStrategy(this));
			maniac.start();
			apiRunning.set(true);
		}
	...
	public void startAuction(Inet4Address dest, Inet4Address finalDest, int id,
			int fine, int maxbid, String payload) {
		...
		// I (lotte) set this because it was missing. TODO do this properly
		int deadline = 10;

		Data data = PacketBuilder.getInstance().buildData(id, dest, deadline,
				fine, payload, finalDest, initialBudget);
