...
public class NetworkManager extends Thread {
	...
	private NetworkManager(Inet4Address IP, TopologyInfo tp, PacketBuilder packetbuilder) {
		this.IP = IP;
		this.tp = tp;
	...
	public static NetworkManager getInstance(Inet4Address IP, TopologyInfo tp, PacketBuilder packetbuilder){
		networkManager = new NetworkManager(IP, tp, packetbuilder);
	...
	public static NetworkManager getInstance(){
		// Simulator: break Singleton-Pattern for multiple Nexus7
		return networkManager;
	}
