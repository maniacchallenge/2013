...
import de.tuhh.maniac.simulator.TxtInfoFaker;
...
public class TxtInfo {
	...
	public String[] request(String req) throws IOException {
		...
		TxtInfoFaker faketxt = new TxtInfoFaker();
		retlist = faketxt.getTxtInfo(req, this.getIP());
	...
	public String[][] command2(String cmd) {
		String[] data = null;
