...
/**
 * Adverts are sent ( by the AuctionManager ) to start the bidding process for a Data packet that has to be forwarded.
 *
...
public class Advert extends Packet {
          ...
          private void parseFromByteArray(byte[] payload) {
	         ...
	         try {
		         //System.err.println((Inet4Address) InetAddress.getByAddress(address));
		        this.finalDestination = (Inet4Address) InetAddress
			     .getByAddress(address);
		         //System.err.println(this.finalDestination);
	         } catch (UnknownHostException e) {
		        this.finalDestination = null;
		         //System.err.println("HOSTEXCEPTION ERROR: setting finalDestination to null");
		        e.printStackTrace();
	         }
          ...
          private byte[] parseToByteArray() {
	         ...
	         if (finalDestination == null) {
		        System.err.println("error: no finalDestination address!");
	         } else {
		        byte[] address = finalDestination.getAddress();
		        for (int i = 0; i < 4; i++) {
...
//		System.out.println("new Packetmessage/AdvertMessage: \n"+packetMessage );
          ...
          public String toString() {
	         return "\nADVERT \n\t transactionID: " + this.transactionID
		      ...
		      + this.destinationIP + " \n\t FinalDestinationIP: " + this.finalDestination
		      + " \n\t ceil: " + this.ceil
