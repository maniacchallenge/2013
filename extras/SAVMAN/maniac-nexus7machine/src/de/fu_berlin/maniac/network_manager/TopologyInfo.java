...
public class TopologyInfo {
	...
	static String nexInterface;

          /**
           * @return the ownIP
           */
          public static InetAddress getOwnIP() {
	         return ownIP;
          }
	...
	public static void setInterface(String nexIntf){
	          nexInterface = nexIntf;
	}
	 ...
	 */
	public static InetAddress getInterfaceIpv4() {
		        
	          
		if(getOwnIP() == null || !intf.equals(nexInterface)){
			...
			while (interfaces.hasMoreElements()) {
				...
				if (current.getName().equalsIgnoreCase(nexInterface)) {
	...
	public static InetAddress getBroadCastAddress(InetAddress ip) {
		...
		try {
			...
			System.err
					.println("could not find broadcast address. Check the selected interface. it is: " + intf);
			return null;
		}
